...
//($arrData['total_fee'])*100
            ...
            if(empty($result["code_url"])){
                return "<script>alert('".$result['err_code_des'].",请联系商家');parent.location.href='/own?payed=1'; </script>";
            }else{
        ...
        <div class="main">
            <div class="pay_main">
                ...
                <div class="pay_main_right">
                    ...
                    <div class="pay_main_right_fk"><div id="myDiv" style="font-weight: 100;">欢迎使用微信支付</div>微信扫码&nbsp;向我付款</div>
                                        <div class="pay_main_right_btn" id="btnBack" onclick="location.href='/own?payed=0';">返回</div>
                </div>
            </div>
...
<script>
    ...
    function load(){
        ...
        xmlhttp.open("POST","/own/orders/wxNotifyUrl",false);
        //下面这句话必须有
        //把标签/值对添加到要发送的头文件。
